...
export default function PrimarySearchAppBar() {
  ...
  const renderAppMenu = (
    ...
    >
      <MenuItem onClick={handleAppMenuClose}>勤務情報</MenuItem>
      <MenuItem onClick={handleAppMenuClose}>給料確認</MenuItem>
      <MenuItem onClick={handleContactMenuClose}>担当者情報</MenuItem>
    </Menu>
  );
